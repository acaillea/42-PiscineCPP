...
/*   Updated: 2022/08/23 16:13:28 by acaillea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap( const std::string strin ) : _name( strin ) , _hitpoint( 10 ) , _enerpoint( 10 ) , _attdamag ( 0 )
{
	std::cout << "ClapTrap String constructor called" << std::endl;
	return ;
}

ClapTrap::ClapTrap( const std::string strin , const unsigned int inhit , const unsigned int inener , const unsigned int inatt) :\
			_name( strin ) , _hitpoint( inhit ) , _enerpoint( inener ) , _attdamag ( inatt )
{
...
void	ClapTrap::takeDamage( unsigned int amount )
{
	if ( this->_hitpoint > 0 )
	{
		std::cout << this->_name << " is attacked and loses " << amount << " of hit points." << std::endl;
...
void	ClapTrap::beRepaired( unsigned int amount )
{
	if ( this->_hitpoint > 0 && this->_enerpoint > 0 )
	{
		std::cout << this->_name << " repairs itself and gains " << amount << " of hit points." << std::endl;
		this->_hitpoint += amount;
		this->_enerpoint -= 1;
	}
	else
